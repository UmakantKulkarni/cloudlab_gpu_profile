...
pc.defineParameter("nodeCount", "Number of GPU Nodes", portal.ParameterType.INTEGER, 1,
                   longDescription="If you specify more then one node, " +
                   "we will create a lan for you.")
pc.defineParameter("user_names", "Usernames (split with space)", portal.ParameterType.STRING, "umakant")
pc.defineParameter("project_group_name", "Project group name", portal.ParameterType.STRING, "sfcs-PG0")
...
pc.defineParameter("phystype",  "Optional physical node type",
                   portal.ParameterType.STRING, "ibm8335",
